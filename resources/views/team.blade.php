			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="team-item">
							<div class="team-image">
								<img src="{{ asset('images/demo/author-2.jpg') }}" class="img-responsive" alt="author">
							</div>
							<div class="team-text">
								<h3>TOM BEKERS</h3>
					...
					<div class="col-md-3">
						<div class="team-item">
							<div class="team-image">
								<img src="{{ asset('images/demo/author-6.jpg') }}" class="img-responsive" alt="author">
							</div>
							<div class="team-text">
								<h3>LINA GOSATA</h3>
					...
					<div class="col-md-3">
						<div class="team-item">
							<div class="team-image">
								<img src="{{ asset('images/demo/author-3.jpg') }}" class="img-responsive" alt="author">
							</div>
							<div class="team-text">
								<h3>Larry Parker</h3>
					...
					<div class="col-md-3">
						<div class="team-item">
							<div class="team-image">
								<img src="{{ asset('images/demo/author-4.jpg') }}" class="img-responsive" alt="author">
							</div>
							<div class="team-text">
								<h3>John BEKERS</h3>
